...
public interface Shape {
     ...
     * 
     * @param x the X double coordinate of the rectangle's upper left corner.
     * @param y the Y double coordinate of the rectangle's upper left corner.
     ...
     *
     * @param at the specified AffineTransform object or null.
     * @param flatness the maximum number of the control points for a given curve
